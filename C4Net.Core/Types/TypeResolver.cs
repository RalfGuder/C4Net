...
using C4Net.Core.AssemblyInfo;

namespace C4Net.Core.Types
{
    /// <summary>
    ...
    public class TypeResolver
    {
        ...
        {
            if (typeName.StartsWith(TypeAssemblyInfo.NullableTypeStarter))
            {
                return null;
            }
        ...
        {
            TypeAssemblyInfo typeInfo = new TypeAssemblyInfo();
        ...
        /// <returns></returns>
        private Type LoadFromAssembly(TypeAssemblyInfo typeInfo)
        {
        ...
        /// <param name="typeInfo">The type info.</param>
        /// <returns></returns>
        private Type LoadFromAllAssemblies(TypeAssemblyInfo typeInfo)
        {
