...
{
    /// <summary>
    /// Interface for the entity Affiliation that represents the table AFFL
	/// 
    ...
    public interface IAffiliation
    {
        ...
        /// </value>
        [AttrIx(100002)]
		[AttrName("affiliation-category-code")]
        ...
        [DataLength(6)]
        [DataDecimals(0)]
        AffiliationCategoryEnum AffiliationCategory { get; set; }
