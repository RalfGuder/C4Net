...
{
    /// <summary>
    /// Interface for the entity ChemicalMaterielType that represents the table CHM_MAT_TYPE
	/// 
    ...
    /// </summary>
	[EntId(10000194)]
    [EntName("CHEMICAL-MATERIEL-TYPE")]
    [EntTableName("CHM_MAT_TYPE")]
    [EntDepth(3)]
    public interface IChemicalMaterielType
    {
        #region - Properties -
		
        /// <summary>
        /// Gets or sets the value of the column chm_mat_type_id
		///
		/// The unique value, or set of characters, assigned to represent a specific OBJECT-TYPE and to distinguish it from all other OBJECT-TYPEs.
        /// </summary>
        /// <value>
        /// Value of the column chm_mat_type_id
        /// </value>
        [AttrIx(100001)]
		[AttrName("chemical-materiel-type-id")]
		[AttrColumnName("chm_mat_type_id")]
        [AttrSeqnr(1)]
        [PrimaryKey]
        [ForeignKey]
        [Mandatory]
        ...
        /// </value>
        [AttrIx(100002)]
		[AttrName("chemical-materiel-type-category-code")]
        ...
        [DataLength(6)]
        [DataDecimals(0)]
        ChemicalMaterielTypeCategoryEnum ChemicalMaterielTypeCategory { get; set; }
        ...
        /// </value>
        [AttrIx(100003)]
		[AttrName("chemical-materiel-type-subcategory-code")]
		[AttrColumnName("subcat_code")]
        [AttrSeqnr(3)]
        [DomId(100000355)]
        [DataLength(6)]
        [DataDecimals(0)]
        ChemicalMaterielTypeSubcategoryEnum? Subcategory { get; set; }
        ...
        /// </value>
        [AttrIx(100004)]
		[AttrName("chemical-materiel-type-persistency-code")]
