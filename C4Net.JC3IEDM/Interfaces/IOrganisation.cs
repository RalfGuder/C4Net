...
{
    /// <summary>
    /// Interface for the entity Organisation that represents the table ORG
	/// 
	/// An OBJECT-ITEM that is an administrative or functional structure.
    /// </summary>
	[EntId(10000085)]
    [EntName("ORGANISATION")]
    [EntTableName("ORG")]
    [EntDepth(1)]
    public interface IOrganisation
    {
        ...
        /// </value>
        [AttrIx(100002)]
		[AttrName("organisation-category-code")]
        ...
        [DataLength(6)]
        [DataDecimals(0)]
        OrganisationCategoryEnum OrganisationCategory { get; set; }
