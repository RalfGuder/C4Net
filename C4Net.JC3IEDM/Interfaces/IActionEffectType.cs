...
{
    /// <summary>
    /// Interface for the entity ActionEffectType that represents the table ACT_EFFECT_TYPE
	/// 
	/// An ACTION-EFFECT of a specific ACTION in accomplishing its aim in relation to a specific OBJECT-TYPE.
    /// </summary>
	[EntId(10000238)]
    [EntName("ACTION-EFFECT-TYPE")]
    [EntTableName("ACT_EFFECT_TYPE")]
    [EntDepth(4)]
    public interface IActionEffectType
    {
        #region - Properties -
        ...
        /// </value>
        [AttrIx(100003)]
		[AttrName("action-effect-type-count")]
		[AttrColumnName("cnt")]
        [AttrSeqnr(3)]
        [Mandatory]
        [DomId(100001800)]
