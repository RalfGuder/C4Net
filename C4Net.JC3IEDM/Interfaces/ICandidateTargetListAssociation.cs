...
{
    /// <summary>
    /// Interface for the entity CandidateTargetListAssociation that represents the table CTGTLST_ASSOC
	/// 
	/// A relationship of a CANDIDATE-TARGET-LIST as a subject with another CANDIDATE-TARGET-LIST as an object.
    /// </summary>
	[EntId(10000145)]
    [EntName("CANDIDATE-TARGET-LIST-ASSOCIATION")]
    [EntTableName("CTGTLST_ASSOC")]
    [EntDepth(4)]
    public interface ICandidateTargetListAssociation
    {
        #region - Properties -
        ...
        /// </value>
        [AttrIx(100001)]
		[AttrName("candidate-target-list-association-subject-candidate-target-list-id")]
        ...
        /// </value>
        [AttrIx(100002)]
		[AttrName("candidate-target-list-association-object-candidate-target-list-id")]
        ...
        /// </value>
        [AttrIx(100003)]
		[AttrName("candidate-target-list-association-category-code")]
        ...
        [DataLength(6)]
        [DataDecimals(0)]
        CandidateTargetListAssociationCategoryEnum CandidateTargetListAssociationCategory { get; set; }
