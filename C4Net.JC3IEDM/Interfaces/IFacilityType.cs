...
{
    /// <summary>
    /// Interface for the entity FacilityType that represents the table FAC_TYPE
	/// 
    ...
    /// </summary>
	[EntId(10000047)]
    [EntName("FACILITY-TYPE")]
    [EntTableName("FAC_TYPE")]
    [EntDepth(1)]
    public interface IFacilityType
    {
        ...
        /// </value>
        [AttrIx(100002)]
		[AttrName("facility-type-category-code")]
        ...
        [DataLength(6)]
        [DataDecimals(0)]
        FacilityTypeCategoryEnum FacilityTypeCategory { get; set; }
