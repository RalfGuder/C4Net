...
{
    /// <summary>
    /// Interface for the entity ActionResourceItem that represents the table ACT_RES_ITEM
	/// 
    ...
    /// </summary>
	[EntId(10000014)]
    [EntName("ACTION-RESOURCE-ITEM")]
    [EntTableName("ACT_RES_ITEM")]
    [EntDepth(3)]
    public interface IActionResourceItem
    {
        #region - Properties -
