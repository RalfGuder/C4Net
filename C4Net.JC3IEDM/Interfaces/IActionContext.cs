...
{
    /// <summary>
    /// Interface for the entity ActionContext that represents the table ACT_CONTXT
	/// 
	/// A relationship between a specific ACTION and a specific CONTEXT.
    /// </summary>
	[EntId(10000005)]
    [EntName("ACTION-CONTEXT")]
    [EntTableName("ACT_CONTXT")]
    [EntDepth(2)]
    public interface IActionContext
    {
        ...
        /// </value>
        [AttrIx(100004)]
		[AttrName("action-context-category-code")]
        ...
        [DataLength(6)]
        [DataDecimals(0)]
        ActionContextCategoryEnum ActionContextCategory { get; set; }
