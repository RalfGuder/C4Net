...
{
    /// <summary>
    /// Interface for the entity Surface that represents the table SURF
	/// 
    ...
    public interface ISurface
    {
        ...
        /// <summary>
        /// Gets or sets the value of the column surf_id
		///
        ...
        /// </summary>
        /// <value>
        /// Value of the column surf_id
        /// </value>
        [AttrIx(100001)]
		[AttrName("surface-id")]
		[AttrColumnName("surf_id")]
        [AttrSeqnr(1)]
        [PrimaryKey]
        [ForeignKey]
        [Mandatory]
        ...
        /// </value>
        [AttrIx(100002)]
		[AttrName("surface-category-code")]
        ...
        [DataLength(6)]
        [DataDecimals(0)]
        SurfaceCategoryEnum SurfaceCategory { get; set; }
