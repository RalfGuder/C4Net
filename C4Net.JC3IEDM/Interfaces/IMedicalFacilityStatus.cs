...
{
    /// <summary>
    /// Interface for the entity MedicalFacilityStatus that represents the table MFS
	/// 
	/// A FACILITY-STATUS that is a record of condition of a specific medical facility.
    /// </summary>
	[EntId(10000175)]
    [EntName("MEDICAL-FACILITY-STATUS")]
    [EntTableName("MFS")]
    [EntDepth(5)]
    public interface IMedicalFacilityStatus
    {
        #region - Properties -
        ...
        /// </value>
        [AttrIx(100003)]
		[AttrName("medical-facility-status-surgery-backlog-duration")]
		[AttrColumnName("surgery_backlog_dur")]
        [AttrSeqnr(3)]
        [Mandatory]
        [DomId(100000700)]
        [DataLength(19)]
        [DataDecimals(0)]
        decimal SurgeryBacklogDuration { get; set; }
