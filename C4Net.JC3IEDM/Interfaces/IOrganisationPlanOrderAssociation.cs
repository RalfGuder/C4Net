...
{
    /// <summary>
    /// Interface for the entity OrganisationPlanOrderAssociation that represents the table ORG_POA
	/// 
	/// A relationship of an ORGANISATION to a PLAN-ORDER specifying the role of the ORGANISATION with respect to the PLAN-ORDER.
    /// </summary>
	[EntId(10000343)]
    [EntName("ORGANISATION-PLAN-ORDER-ASSOCIATION")]
    [EntTableName("ORG_POA")]
    [EntDepth(2)]
    public interface IOrganisationPlanOrderAssociation
    {
        #region - Properties -
        ...
        /// </value>
        [AttrIx(100004)]
		[AttrName("organisation-plan-order-association-category-code")]
        ...
        [DataLength(6)]
        [DataDecimals(0)]
        OrganisationPlanOrderAssociationCategoryEnum OrganisationPlanOrderAssociationCategory { get; set; }
