...
{
    /// <summary>
    /// Interface for the entity ObjectItemType that represents the table OBJ_ITEM_TYPE
	/// 
	/// A record of the perceived classification of a specific OBJECT-ITEM as a specific OBJECT-TYPE.
    /// </summary>
	[EntId(10000081)]
    [EntName("OBJECT-ITEM-TYPE")]
    [EntTableName("OBJ_ITEM_TYPE")]
    [EntDepth(3)]
    public interface IObjectItemType
    {
        #region - Properties -
        ...
        /// </value>
        [AttrIx(100003)]
		[AttrName("object-item-type-index")]
		[AttrColumnName("obj_item_type_ix")]
        [AttrSeqnr(3)]
        [PrimaryKey]
        [Mandatory]
        [DomId(100001000)]
