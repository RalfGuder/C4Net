...
{
    /// <summary>
    /// Interface for the entity MedicalFacilityStatusPendingCasualtyEvacuation that represents the table MFS_PEND_CAS_EVAC
	/// 
	/// The count of pending evacuees in each group according to the intended destination for a specific MEDICAL-FACILITY-STATUS.
    /// </summary>
	[EntId(10000176)]
    [EntName("MEDICAL-FACILITY-STATUS-PENDING-CASUALTY-EVACUATION")]
    [EntTableName("MFS_PEND_CAS_EVAC")]
    [EntDepth(6)]
    public interface IMedicalFacilityStatusPendingCasualtyEvacuation
    {
        #region - Properties -
        ...
        /// </value>
        [AttrIx(100003)]
		[AttrName("medical-facility-status-pending-casualty-evacuation-index")]
		[AttrColumnName("mfs_cas_evac_ix")]
        [AttrSeqnr(3)]
        [PrimaryKey]
        [Mandatory]
        [DomId(100001000)]
        ...
        /// </value>
        [AttrIx(100004)]
		[AttrName("medical-facility-status-pending-casualty-evacuation-destination-code")]
        ...
        /// </value>
        [AttrIx(100005)]
		[AttrName("medical-facility-status-pending-casualty-evacuation-sitting-count")]
		[AttrColumnName("sitting_cnt")]
        [AttrSeqnr(5)]
        [Mandatory]
        [DomId(100001800)]
        [DataLength(6)]
        [DataDecimals(0)]
        int SittingCount { get; set; }
        ...
        /// </value>
        [AttrIx(100006)]
		[AttrName("medical-facility-status-pending-casualty-evacuation-stretcher-count")]
		[AttrColumnName("stretcher_cnt")]
        [AttrSeqnr(6)]
        [Mandatory]
        [DomId(100001800)]
        [DataLength(6)]
        [DataDecimals(0)]
        int StretcherCount { get; set; }
