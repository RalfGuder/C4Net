...
{
    /// <summary>
    /// Expression class for query the entity ObjectTypeAffiliation.
    /// </summary>
    public class ObjectTypeAffiliationExpression : BaseEntityExpression<ObjectTypeAffiliationExpression>
    {
        #region - Properties -
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectTypeAffiliationExpression"/> class.
        /// </summary>
        public ObjectTypeAffiliationExpression()
            : base("ObjectTypeAffiliation", typeof(IObjectTypeAffiliation))
        {
        }
