...
{
    /// <summary>
    /// Expression class for query the entity ObjectItemType.
    /// </summary>
    public class ObjectItemTypeExpression : BaseEntityExpression<ObjectItemTypeExpression>
    {
        #region - Properties -
        ...
        /// <summary>
        /// Expression for the property Index that represents the column obj_item_type_ix.
        /// </summary>
        /// <value>
        /// The value of the property Index that represents the column obj_item_type_ix.
        /// </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectItemTypeExpression"/> class.
        /// </summary>
        public ObjectItemTypeExpression()
            : base("ObjectItemType", typeof(IObjectItemType))
        {
        }
