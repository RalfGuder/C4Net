...
{
    /// <summary>
    /// Expression class for query the entity ObjectItemAssociationStatus.
    /// </summary>
    public class ObjectItemAssociationStatusExpression : BaseEntityExpression<ObjectItemAssociationStatusExpression>
    {
        #region - Properties -
        ...
        /// <summary>
        /// Expression for the property Index that represents the column obj_item_assoc_stat_ix.
        /// </summary>
        /// <value>
        /// The value of the property Index that represents the column obj_item_assoc_stat_ix.
        /// </value>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="ObjectItemAssociationStatusExpression"/> class.
        /// </summary>
        public ObjectItemAssociationStatusExpression()
            : base("ObjectItemAssociationStatus", typeof(IObjectItemAssociationStatus))
        {
        }
