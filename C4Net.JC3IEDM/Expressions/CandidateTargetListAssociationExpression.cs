...
{
    /// <summary>
    /// Expression class for query the entity CandidateTargetListAssociation.
    /// </summary>
    public class CandidateTargetListAssociationExpression : BaseEntityExpression<CandidateTargetListAssociationExpression>
    {
        #region - Properties -
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CandidateTargetListAssociationExpression"/> class.
        /// </summary>
        public CandidateTargetListAssociationExpression()
            : base("CandidateTargetListAssociation", typeof(ICandidateTargetListAssociation))
        {
        }
