...
{
    /// <summary>
    /// Class for the entity OBJECT-TYPE-AFFILIATION that represents the table OBJ_TYPE_AFFL.
	///
	/// A relationship between a specific OBJECT-TYPE and a specific AFFILIATION that identifies an inherent allegiance.
    /// </summary>
    [Serializable]
    [DefinitionName("ObjectTypeAffiliation", "C4Net.JC3IEDM.Definitions.ObjectTypeAffiliation.definition.xml")]
    public class ObjectTypeAffiliation : IEntity, IObjectTypeAffiliation
    {
        #region - Fields - 
        ...
        /// </summary>
        public static readonly ObjectTypeAffiliationExpression _ = new ObjectTypeAffiliationExpression();
