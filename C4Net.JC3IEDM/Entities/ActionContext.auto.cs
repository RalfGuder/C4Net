...
{
    /// <summary>
    /// Class for the entity ACTION-CONTEXT that represents the table ACT_CONTXT.
	///
	/// A relationship between a specific ACTION and a specific CONTEXT.
    /// </summary>
    [Serializable]
    [DefinitionName("ActionContext", "C4Net.JC3IEDM.Definitions.ActionContext.definition.xml")]
    public class ActionContext : IEntity, IActionContext
    {
        #region - Fields - 
        ...
        /// </summary>
        public static readonly ActionContextExpression _ = new ActionContextExpression();
        ...
        /// </value>
		public ActionContextCategoryEnum ActionContextCategory { get; set; }
