...
{
    /// <summary>
    /// Class for the entity CONTEXT-OBJECT-ITEM-ASSOCIATION that represents the table CONTXT_OI_ASSOC.
	///
	/// A relationship of a CONTEXT as a subject with an OBJECT-ITEM as an object.
    /// </summary>
    [Serializable]
    [DefinitionName("ContextObjectItemAssociation", "C4Net.JC3IEDM.Definitions.ContextObjectItemAssociation.definition.xml")]
    public class ContextObjectItemAssociation : IEntity, IContextObjectItemAssociation
    {
        #region - Fields - 
        ...
        /// </summary>
        public static readonly ContextObjectItemAssociationExpression _ = new ContextObjectItemAssociationExpression();
        ...
        /// </value>
		public ContextObjectItemAssociationCategoryEnum ContextObjectItemAssociationCategory { get; set; }
