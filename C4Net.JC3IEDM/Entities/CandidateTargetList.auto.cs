...
{
    /// <summary>
    /// Class for the entity CANDIDATE-TARGET-LIST that represents the table CTGTLST.
	///
    ...
    /// </summary>
    [Serializable]
    [DefinitionName("CandidateTargetList", "C4Net.JC3IEDM.Definitions.CandidateTargetList.definition.xml")]
    public class CandidateTargetList : IEntity, ICandidateTargetList
    {
        #region - Fields - 
        ...
        /// </summary>
        public static readonly CandidateTargetListExpression _ = new CandidateTargetListExpression();
