...
{
    /// <summary>
    /// Class for the entity PLAN-ORDER-COMPONENT that represents the table POC.
	///
	/// A structural element of a specific PLAN-ORDER.
    /// </summary>
    [Serializable]
    [DefinitionName("PlanOrderComponent", "C4Net.JC3IEDM.Definitions.PlanOrderComponent.definition.xml")]
    public class PlanOrderComponent : IEntity, IPlanOrderComponent
    {
        #region - Fields - 
        ...
        /// </summary>
        public static readonly PlanOrderComponentExpression _ = new PlanOrderComponentExpression();
