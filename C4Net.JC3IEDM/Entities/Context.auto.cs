...
{
    /// <summary>
    /// Class for the entity CONTEXT that represents the table CONTXT.
	///
    ...
    /// </summary>
    [Serializable]
    [DefinitionName("Context", "C4Net.JC3IEDM.Definitions.Context.definition.xml")]
    public class Context : IEntity, IContext
    {
        ...
        /// </summary>
        public static readonly ContextExpression _ = new ContextExpression();
        ...
        /// </value>
		public ContextCategoryEnum ContextCategory { get; set; }
