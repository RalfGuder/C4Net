...
{
    /// <summary>
    /// Class for the entity OPERATIONAL-INFORMATION-GROUP-ORGANISATION-ASSOCIATION-STATUS that represents the table OIG_ORG_ASSOC_STAT.
	///
    ...
    /// </summary>
    [Serializable]
    [DefinitionName("OperationalInformationGroupOrganisationAssociationStatus", "C4Net.JC3IEDM.Definitions.OperationalInformationGroupOrganisationAssociationStatus.definition.xml")]
    public class OperationalInformationGroupOrganisationAssociationStatus : IEntity, IOperationalInformationGroupOrganisationAssociationStatus
    {
        #region - Fields - 
        ...
        /// </summary>
        public static readonly OperationalInformationGroupOrganisationAssociationStatusExpression _ = new OperationalInformationGroupOrganisationAssociationStatusExpression();
        ...
        /// </value>
		public decimal OperationalInformationGroupOrganisationAssociationIndex { get; set; }
        ...
        /// </value>
		public AssociationStatusCategoryEnum OperationalInformationGroupOrganisationAssociationStatusCategory { get; set; }
