...
{
    /// <summary>
    /// Class for the entity OBJECT-ITEM-COMMENT that represents the table OBJ_ITEM_CMT.
	///
	/// A comment that adds information about a specific OBJECT-ITEM.
    /// </summary>
    [Serializable]
    [DefinitionName("ObjectItemComment", "C4Net.JC3IEDM.Definitions.ObjectItemComment.definition.xml")]
    public class ObjectItemComment : IEntity, IObjectItemComment
    {
        #region - Fields - 
        ...
        /// </summary>
        public static readonly ObjectItemCommentExpression _ = new ObjectItemCommentExpression();
