...
{
    /// <summary>
    /// Class for the entity ORGANISATION-STRUCTURE-DETAIL that represents the table ORG_STRUCT_DET.
	///
	/// The identification of a specific OBJECT-ITEM-ASSOCIATION as an element in a specific ORGANISATION-STRUCTURE.
    /// </summary>
    [Serializable]
    [DefinitionName("OrganisationStructureDetail", "C4Net.JC3IEDM.Definitions.OrganisationStructureDetail.definition.xml")]
    public class OrganisationStructureDetail : IEntity, IOrganisationStructureDetail
    {
        #region - Fields - 
        ...
        /// </summary>
        public static readonly OrganisationStructureDetailExpression _ = new OrganisationStructureDetailExpression();
