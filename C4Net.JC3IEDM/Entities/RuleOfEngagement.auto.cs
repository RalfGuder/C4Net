...
{
    /// <summary>
    /// Class for the entity RULE-OF-ENGAGEMENT that represents the table ROE.
	///
	/// A specification of mandatory guidance for the way a given activity is to be executed.
    /// </summary>
    [Serializable]
    [DefinitionName("RuleOfEngagement", "C4Net.JC3IEDM.Definitions.RuleOfEngagement.definition.xml")]
    public class RuleOfEngagement : IEntity, IRuleOfEngagement
    {
        #region - Fields - 
        ...
        /// </summary>
        public static readonly RuleOfEngagementExpression _ = new RuleOfEngagementExpression();
        ...
        /// </value>
		public decimal? OwningOrganisationId { get; set; }
