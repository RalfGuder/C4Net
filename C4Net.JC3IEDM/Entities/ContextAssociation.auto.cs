...
{
    /// <summary>
    /// Class for the entity CONTEXT-ASSOCIATION that represents the table CONTXT_ASSOC.
	///
	/// A relationship of a CONTEXT as a subject with another CONTEXT as an object.
    /// </summary>
    [Serializable]
    [DefinitionName("ContextAssociation", "C4Net.JC3IEDM.Definitions.ContextAssociation.definition.xml")]
    public class ContextAssociation : IEntity, IContextAssociation
    {
        #region - Fields - 
        ...
        /// </summary>
        public static readonly ContextAssociationExpression _ = new ContextAssociationExpression();
        ...
        /// </value>
		public decimal SubjectContextId { get; set; }
        ...
        /// </value>
		public decimal ObjectContextId { get; set; }
        ...
        /// </value>
		public ContextAssociationCategoryEnum ContextAssociationCategory { get; set; }
