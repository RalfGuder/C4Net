...
{
    /// <summary>
    /// Class for the entity CANDIDATE-TARGET-LIST-ASSOCIATION that represents the table CTGTLST_ASSOC.
	///
	/// A relationship of a CANDIDATE-TARGET-LIST as a subject with another CANDIDATE-TARGET-LIST as an object.
    /// </summary>
    [Serializable]
    [DefinitionName("CandidateTargetListAssociation", "C4Net.JC3IEDM.Definitions.CandidateTargetListAssociation.definition.xml")]
    public class CandidateTargetListAssociation : IEntity, ICandidateTargetListAssociation
    {
        #region - Fields - 
        ...
        /// </summary>
        public static readonly CandidateTargetListAssociationExpression _ = new CandidateTargetListAssociationExpression();
        ...
        /// </value>
		public CandidateTargetListAssociationCategoryEnum CandidateTargetListAssociationCategory { get; set; }
