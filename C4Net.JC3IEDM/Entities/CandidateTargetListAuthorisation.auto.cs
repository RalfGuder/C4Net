...
{
    /// <summary>
    /// Class for the entity CANDIDATE-TARGET-LIST-AUTHORISATION that represents the table CTGTLST_AUTH.
	///
    ...
    /// </summary>
    [Serializable]
    [DefinitionName("CandidateTargetListAuthorisation", "C4Net.JC3IEDM.Definitions.CandidateTargetListAuthorisation.definition.xml")]
    public class CandidateTargetListAuthorisation : IEntity, ICandidateTargetListAuthorisation
    {
        #region - Fields - 
        ...
        /// </summary>
        public static readonly CandidateTargetListAuthorisationExpression _ = new CandidateTargetListAuthorisationExpression();
        ...
        /// </value>
		public CandidateTargetListAuthorisationIndicatorEnum Indicator { get; set; }
