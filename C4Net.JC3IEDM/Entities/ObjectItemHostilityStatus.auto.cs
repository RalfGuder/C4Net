...
{
    /// <summary>
    /// Class for the entity OBJECT-ITEM-HOSTILITY-STATUS that represents the table OBJ_ITEM_HSTLY_STAT.
	///
	/// A record of the perceived hostility classification of a specific OBJECT-ITEM.
    /// </summary>
    [Serializable]
    [DefinitionName("ObjectItemHostilityStatus", "C4Net.JC3IEDM.Definitions.ObjectItemHostilityStatus.definition.xml")]
    public class ObjectItemHostilityStatus : IEntity, IObjectItemHostilityStatus
    {
        #region - Fields - 
        ...
        /// </summary>
        public static readonly ObjectItemHostilityStatusExpression _ = new ObjectItemHostilityStatusExpression();
        ...
        /// </value>
		public ObjectItemHostilityStatusEnum ObjectItemHostilityStatusCode { get; set; }
