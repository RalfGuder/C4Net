...
namespace C4Net.Metamodel.Expressions
{
    ...
    /// </summary>
    public class EntExpression : BaseEntityExpression<EntExpression>
    {
        #region - Properties -
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="EntExpression"/> class.
        /// </summary>
        public EntExpression()
            : base("[%LogicalName%%]", typeof(IEnt))
        {
        }
