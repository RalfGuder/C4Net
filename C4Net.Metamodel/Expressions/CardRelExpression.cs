...
namespace C4Net.Metamodel.Expressions
{
    ...
    /// </summary>
    public class CardRelExpression : BaseEntityExpression<CardRelExpression>
    {
        #region - Properties -
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CardRelExpression"/> class.
        /// </summary>
        public CardRelExpression()
            : base("[%LogicalName%%]", typeof(ICardRel))
        {
        }
