...
namespace C4Net.Metamodel.Expressions
{
    ...
    /// </summary>
    public class AttrExpression : BaseEntityExpression<AttrExpression>
    {
        #region - Properties -
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="AttrExpression"/> class.
        /// </summary>
        public AttrExpression()
            : base("[%LogicalName%%]", typeof(IAttr))
        {
        }
