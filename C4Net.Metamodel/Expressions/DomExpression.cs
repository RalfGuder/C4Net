...
namespace C4Net.Metamodel.Expressions
{
    ...
    /// </summary>
    public class DomExpression : BaseEntityExpression<DomExpression>
    {
        #region - Properties -
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="DomExpression"/> class.
        /// </summary>
        public DomExpression()
            : base("[%LogicalName%%]", typeof(IDom))
        {
        }
