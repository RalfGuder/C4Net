...
namespace C4Net.Data.Expressions.Evaluator
{
    ...
    public class ExprEvaluator : ExprReviewer
    {
        ...
        protected override Expression Review(Expression expression)
        {
            ...
            {
                return expression.NodeType == ExpressionType.Constant ? expression : Expression.Constant(Expression.Lambda(expression).Compile().DynamicInvoke(null), expression.Type);
            }
