...
using C4Net.Data.Base;
using C4Net.Data.Connections;
using C4Net.Data.Definitions;

namespace C4Net.Data.Builders
{
    /// <summary>
    /// Class for the builder for BaseCommand classes for the basic SQL commands.
    /// </summary>
    public class CommandBuilder
    {
        ...
        /// <summary>
        /// The default full table mapping for the type.
        /// </summary>
        ...
        /// <summary>
        /// The cache of commands by the command type.
        /// </summary>
        private Dictionary<CommandType, IDbCommand> commandCache = new Dictionary<CommandType, IDbCommand>();

        /// <summary>
        /// The object proxy for the type.
        /// </summary>
        private IObjectProxy proxy = null;
        ...
        /// <summary>
        /// Gets the default table mapping.
        /// </summary>
        /// <value>
        ...
        {
            get { return this.defaultTableMapping; }
        }
        ...
        public CommandBuilder(string connectionName, Type type)
        {
            this.connectionName = connectionName;
            this.Definition = DefinitionManager.GetDefinition(type);
            this.connectionManager = DefaultContainer.Get<IDbConnectionManager>();
            this.connection = connectionManager.GetConnection(this.connectionName);
            this.providerName = connectionManager.GetConnectionInfo(this.connectionName).ProviderName;
            this.defaultTableMapping = this.GetDataTableMapping();
        ...
        /// <summary>
        /// Gets the data table mapping.
        /// </summary>
        /// <returns></returns>
        public DataTableMapping GetDataTableMapping()
        {
            return this.GetDataTableMapping(null);
        }

        /// <summary>
        /// Gets the data table mapping by column names.
        /// </summary>
        ...
        public DataTableMapping GetDataTableMapping(string[] columnNames)
        {
            ...
            foreach (ColumnDefinition columnDefinition in this.Definition.Columns.Values)
            {
        ...
        /// <summary>
        /// Gets the full name of a physical table.
        /// </summary>
        /// <param name="connectionName">Name of the connection.</param>
        /// <param name="sourceName">Name of the table.</param>
        /// <returns></returns>
        private string GetFullSourceName(string connectionName, string sourceName)
        {
            return this.connectionManager.GetFullSourceName(connectionName, sourceName);
        }
        ...
        {
            return this.GetFullSourceName(this.connectionName, this.Definition.TableName);
        }
        ...
        private BaseCommand BuildConditionCommand(DataTableMapping mapping, ref int paramNumber)
        {
            ...
            if (this.Definition.PrimaryKeys.Count > 0)
            {
                ...
                {
                    string primaryKey = this.Definition.PrimaryKeys[i];
                    string parameterName = this.GetParameterStr(paramNumber++);
                    DataColumnMapping columnMapping = mapping.ColumnMappings.GetByDataSetColumn(primaryKey);
                    ColumnDefinition columnDefinition = this.Definition.Columns[primaryKey];
            ...
            else
            {
                for (int i = 0; i < mapping.ColumnMappings.Count; i++)
                {
                    ...
                    ColumnDefinition columnDefinition = this.Definition.Columns[columnName];
                    string parameterName = this.GetParameterStr(paramNumber++);
        ...
        {
            return new BaseCommand("SELECT SUM(" + this.Definition.Columns[columnName].ColumnName + ") FROM " + this.GetFullSourceName());
        }
        ...
        {
            return new BaseCommand("SELECT AVG(" + this.Definition.Columns[columnName].ColumnName + ") FROM " + this.GetFullSourceName());
        }
        ...
        {
            return new BaseCommand("SELECT MAX(" + this.Definition.Columns[columnName].ColumnName + ") FROM " + this.GetFullSourceName());
        }
        ...
        {
            return new BaseCommand("SELECT MIN(" + this.Definition.Columns[columnName].ColumnName + ") FROM " + this.GetFullSourceName());
        }
