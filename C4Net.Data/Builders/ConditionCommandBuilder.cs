...
using C4Net.Core.Expressions.Operators;
...
namespace C4Net.Data.Builders
{
    ...
    public class ConditionCommandBuilder
    {
        ...
        public ConditionCommandBuilder(ConditionExpression conditionExpression, TableDefinition definition)
        {
        ...
        private DbType GetDbType(OperationElement element)
        {
            ...
            if (this.Definition.Columns.ContainsKey(columnName))
            {
                return this.Definition.Columns[columnName].DataType;
            }
        ...
        private string GetExpressionStr(ColumnExpression expression)
        {
            ...
            {
                return this.Definition.Columns[(string)expression].ColumnName;
            }
        }
        ...
        private string GetExpressionStr(SortExpression expression)
        {
            ...
            {
                return "[" + this.Definition.Columns[expression.ColumnName].ColumnName + "] DESC";
            }
            else  
            {
                return "[" + this.Definition.Columns[expression.ColumnName].ColumnName + "] ASC";
            }
        }
        ...
        /// <returns></returns>
        public static BaseCommand GetCommand(ConditionExpression conditionExpression, TableDefinition definition)
        {
