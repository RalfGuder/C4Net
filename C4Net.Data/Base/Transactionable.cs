...
namespace C4Net.Data.Base
{
    ...
    public class Transactionable : LoggableClass, ITransactionManager
    {
        ...
        {
            this.TransactionManager = DefaultContainer.Get<ITransactionFactory>().GetTransactionManager(connection);
        }
        ...
        public Transactionable(string connectionName)
            : this(DefaultContainer.Get<IDbConnectionManager>().GetConnection(connectionName))
        {
        }
        ...
        public Transactionable()
            : this(DefaultContainer.Get<IDbConnectionManager>().GetConnection())
        {
        }
