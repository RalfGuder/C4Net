...
namespace C4Net.Data.Base
{
    public static class CommandConverter
    {
        ...
        public static string ReplaceParameterName(CommandType commandType, string baseParamName, string baseParamPrefix, string providerName, ref string commandText)
        {
            ...
            string paramName = DefaultContainer.Get<IDbProviderManager>().GetParameterName(providerName, baseParamName, baseParamPrefix, out commonParamName);
        ...
        {
            return DefaultContainer.Get<IConversionManager>().Convert(propertyType, dbType, value);
        }
