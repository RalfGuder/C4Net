...
{
    /// <summary>
    /// Class for a basic parser based on state machine.
    /// </summary>
    public abstract class BaseParser
    {
        ...
        {
            if (actualPosition < sourceLength)
            {
                this.actualChar = this.source[actualPosition++];
                return true;
            }
            return false;
        }
        ...
        {
            if ((actualPosition+i) < sourceLength)
            {
                return this.source[actualPosition+i];
            }
            return '\0';
        }
        ...
        private void Append()
        {
            this.builder.Append(this.actualChar);
        }
